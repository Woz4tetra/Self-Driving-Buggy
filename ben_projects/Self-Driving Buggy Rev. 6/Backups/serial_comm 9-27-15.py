...
entering the address manually.")
    ...
    def sendPacket(self):
        if not self.sendQueue.empty():
            ...
            print time.time(), "writing: ", repr(packet)
            self.serialRef.write(packet)
            print time.time(), "wrote: ", repr(packet)
    ...
    def dump(self):
        ...
        with self.receivedQueue.mutex:
            self.receivedQueue.queue.clear()
