        ...
        unsigned char *data)
{
    ...
    /* error marker 2 11/12 */
    Serial.println("something 3");
    Serial.println(st->chip_cfg.sensors); // for some reason this value is 0. I don't know what it means
    if (!st->chip_cfg.sensors)
        return -1;
    ...
    Serial.println("something 7");
    if (i2c_read(st->hw->addr, st->reg->mem_r_w, length, data)) {
        return -1;
    }
    Serial.println("something 8");
